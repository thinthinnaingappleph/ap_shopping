...
<div class="wrapper">
  ...
  <?php if($page != 'order-list.php' && $page != 'weekly_report.php' && $page != 'monthly_report.php' && $page != 'royal_user.php' && $page != 'best_seller.php') { ?>
    ...
    <a href="logout.php" type="button" class="btn btn-default ml-auto">Logout</a>
  </nav>
  <!-- /.navbar -->
