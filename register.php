					...
					<div class="login_form_inner">
						...
						<form class="row login_form" action="register.php" method="post" id="contactForm" novalidate="novalidate">
							...
							<div class="col-md-12 form-group">
                                ...
                                style="<?php echo empty($passwordError) ? '': 'border: 1px solid red'?>" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Password'">
                                <p style="color:red;text-align:left;"><?php echo empty($passwordError) ? '': $passwordError?></p>
                            </div>
							
							<div class="col-md-12 form-group">
                                <button type="submit" value="submit" class="primary-btn">Register</button>		
                                <a href="login.php" type="button" class="primary-btn" style="color: white">Login</button>						
							</div>
						</form>
					</div>
				</div>
